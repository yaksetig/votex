...
export default function GenerateKeypairButton() {
  ...
  const [keypair, setKeypair] = useState<{ k: bigint; Ax: string; Ay: string } | null>(null);
    ...
    <div>
      ...
      {keypair && (
        <div className="mt-4 p-4 bg-gray-100 rounded">
          <p><strong>Private key (k):</strong> {keypair.k}</p>
          <p><strong>Public A:</strong> ({keypair.Ax}, {keypair.Ay})</p>
        </div>
      )}
    </div>
  );
