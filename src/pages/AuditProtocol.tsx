  ...
  return (
    <div className="civic-container py-10 pb-28 md:pb-12">
      <section className="civic-card mx-auto max-w-4xl p-6 sm:p-10">
        ...
        <h1 className="mt-3 font-headline text-3xl font-bold tracking-[-0.03em] text-primary">Audit protocol</h1>
        ...
        <p className="mt-8 rounded-lg bg-tertiary-fixed/25 p-4 text-sm text-on-surface-variant">The current Groth16 setup limitation remains documented in the repository’s cryptography guide. This pre-production hardening does not replace cryptographic artifacts.</p>
      </section>
    </div>
  );
}
