...
const MOBILE_NAV = [
  { to: "/elections", label: "Elections", icon: Compass, match: (path: string) => path === "/elections" },
  {
    to: "/elections",
    label: "Vote",
    icon: Vote,
  ...
  { to: "/dashboard", label: "Profile", icon: UserCircle2, match: (path: string) => path === "/dashboard" || path === "/success" },
];
